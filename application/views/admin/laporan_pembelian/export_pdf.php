...
<head>
    ...
    <style>
        ...
        .meta-info { margin-bottom: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px; }
...
<body>
    ...
    <div class="meta-info">
        ...
        <?= ($start && $end) ? date('d/m/Y', strtotime($start)) . ' - ' . date('d/m/Y', strtotime($end)) : 'Semua Waktu'; ?>
        <br>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="150">Total Pembelian</th>
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            <tr>
                ...
                <td class="text-right">Rp <?= number_format($r->total_pembelian, 0, ',', '.'); ?></td>
            </tr>
            <?php endforeach; else: ?>
            <tr>
